...
export const REGLES: readonly Regle[] = [
  ...
  { code: 'R03', cle: 'forfait', libelle: 'Forfait affiché et accepté avant chaque emprunt. Charte acceptée à la 1re connexion.' },
  ...
  { code: 'R06', cle: 'reemprunt', libelle: 'Niveau 2 : le matériel peut repartir avant le contrôle ; la photo protège le nouvel emprunteur.' },
  { code: 'R07', cle: 'composant', libelle: 'Composant manquant : on doit le forfait du composant, pas celui du kit.' },
  { code: 'R08', cle: 'retour', libelle: 'Seul le responsable du prêt fait le retour.' },
  { code: 'R09', cle: 'classe', libelle: '« Pour ma classe » réservé aux intervenants, qui restent responsables.' },
  ...
  { code: 'R12', cle: 'argent', libelle: 'Forfaits, ajustements (baisse seulement) et paiements : réservés à Sandrine.' },
  { code: 'R13', cle: 'equipe', libelle: "Valider, contrôler, gérer : réservé à l'équipe." },
  { code: 'R14', cle: 'prevenez', libelle: '« Me prévenir » : tous les inscrits du type sont prévenus au retour, le premier qui scanne le prend.' },
  { code: 'R15', cle: 'temps', libelle: "Rappel à 16h30 aux emprunteurs, récap de 8h à l'équipe." },
  { code: 'R16', cle: 'deblocage', libelle: "L'équipe peut débloquer une personne pour la journée uniquement." },
] as const
